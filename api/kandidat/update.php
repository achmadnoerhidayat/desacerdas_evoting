...
$temp_pres = isset($_FILES['image_pres']['tmp_name']) ? $_FILES['image_pres']['tmp_name'] : "";
$name_pres = isset($_FILES['image_pres']['name']) ? $_FILES['image_pres']['name'] : "";
$size_pres = isset($_FILES['image_pres']['size']) ? $_FILES['image_pres']['size'] : 0;
$type_pres = isset($_FILES['image_pres']['type']) ? $_FILES['image_pres']['type'] : "";
// ambil file input kk
$temp_wakil = isset($_FILES['image_w_pres']['tmp_name']) ? $_FILES['image_w_pres']['tmp_name'] : "";
$name_wakil = isset($_FILES['image_w_pres']['name']) ? $_FILES['image_w_pres']['name'] : "";
$size_wakil = isset($_FILES['image_w_pres']['size']) ? $_FILES['image_w_pres']['size'] : 0;
$type_wakil = isset($_FILES['image_w_pres']['type']) ? $_FILES['image_w_pres']['type'] : "";
...
if (isset($_POST['no_pres'])) {
    if (!is_numeric($_POST['no_pres'])) {
        array_push($error, [
            'no_pres' => 'No Presiden Suport Numeric'
        ]);
    }
}
...
if (isset($_POST['no_wakil'])) {
    if (!is_numeric($_POST['no_wakil'])) {
        array_push($error, [
            'no_wakil' => 'No Wakil Presiden Suport Numeric'
        ]);
    }
}
...
$params['no_pres'] = $_POST['no_pres'];
$params['no_wakil'] = $_POST['no_wakil'];
